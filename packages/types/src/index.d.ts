...
export interface ReferenceProfile {
    ...
    category: 'Research Institution' | 'Software Engineering' | 'Cybersecurity' | 'Systems & Infrastructure' | 'Academic' | 'Open Source' | 'Creative Technologist' | 'AI & Machine Learning';
    profileType: string;
    description: string;
